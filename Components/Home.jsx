  ...
  return (
    <div className="Home">
      ...
      <section className="Services-Home">
        <Info primaryText="Services" heading="Transforming Digital Visions into Reality" font={spaceGrotesk} />
        <div className="cards">
          <Card
            img={{
      ...
      <section className="Blog-Home">
        <div className="top">
          ...
          <Info primaryText="Blog" subheading="Navigating the Digital Sphere " font={spaceGrotesk} />
          <CustomButton
            buttons={[
              {
                title: "See All",
